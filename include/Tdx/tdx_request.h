...
/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|140_证券代码|362_页面标识|5250_CPU|5251_HD|5252_LIP|5253_系统节点编号|5254_真实营业部代码|5255_客户姓名|5256_客户代码|5257_股东代码表|5258_信用交易标志|5259_认证编 号|5261_机器绑定信息|5262_机器信息|5263_客户端版本|
===============
100_交易所代码|140_证券代码|141_证券名称|125_帐号类别|132_币种|1228_模式|958_国债标识|960_证券类别|1213_保留信息|
*/
#define REQUEST_178		178		// 不知道什么功能
...
/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|126_开始日期|127_终止日期|1207_起始序号|5250_客户群组|5251_客户营业部|5252_硬盘序列号|5253_CPUID|5254_信用交易标识|5255_会话号|5256_客户代码|5257_版本号|
===============
170_配号日期|123_股东代码|140_证券代码|141_证券名称|171_起始配号|172_配号数量|1213_保留信息|
*/
#define REQUEST_XGSG_XGPHCX		1116	// 新股配号查询
...
/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|100_交易所代码|140_证券代码|1207_起始序号|126_开始日期|127_终止日期|1227_参数|5250_客户群组|5251_客户营业部|5252_硬盘序列号|5253_CPUID|5254_信用交易标识|5255_会话号|5256_客户代码|5257_版本号|
===============
176_中签日期|140_证券代码|141_证券名称|152_成交数量|123_股东代码|1213_保留信息|
*/
#define REQUEST_XGSG_XGZQCX		1126	// 新股中签查询

/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|126_开始日期|127_终止日期|113_操作标志|1207_起始序号|5250_客户群组|5251_客户营业部|5252_硬盘序列号|5253_CPUID|5254_信用交易标识|5255_会话号|5256_客户代码|5257_版本 号|
===============
5850_发行日期|141_证券名称|140_证券代码|418_发行价格|961_最高数量|962_最低数量|142_委托日期|101_交易所名称|1227_参数|125_帐号类别|1213_保留信息|
*/
#define REQUEST_XGSG_KSGXGCX	1156	// 可申购新股查询
//////////////////////////////////////////////////////////////////////////
// 期权部分
/*
...
/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|100_交易所代码|1207_起始序号|5250_客户群组|5251_客户营业部|5252_硬盘序列号|5253_CPUID|5254_信用交易标识|5255_会话号|5256_客户代码|5257_版本号|
===============
120_客户号|100_交易所代码|101_交易所名称|123_股东代码|173_席位代码|5747_申购额度|1227_参数|125_帐号类别|1213_保留信息|
*/
#define REQUEST_XGSG_XGSGEDCX	1340	// 新股申购额度查询

/*
120_客户号|134_交易密码|121_资金帐号|125_帐号类别|123_股东代码|110_委托方式|126_开始日期|127_终止日期|113_操作标志|1207_起始序号|5250_客户群组|5251_客户营业部|5252_硬盘序列号|5253_CPUID|5254_信用交易标识|5255_会话号|5256_客户代码|5257_版本 号|
===============
120_客户号|140_证券代码|141_证券名称|153_成交价格|132_币种|174_中签数|1088_中签金额|5811_已缴款数量|5814_已缴款金额|5812_应补缴数量|5815_应补缴金额|5736_到账日期|123_股东代码|101_交易所名称|1213_保留信息|
*/
#define REQUEST_XGSG_XGSGDJKCX	1370	// 新股申购待缴款查询,在国信证券中叫 新股中签查询

/*
*/
#define REQUEST_XGSG_LSZQCX	1372	// 历史中签查询，在国信证券中有这个功能
...
120_产品账号|134_交易密码|121_产品账号|125_帐号类别|123_股东代码|1206_客户类别|1210_认证方式|1211_认证信息|122_客户名称|454_证件号码|455_移动电话|128_用户联系方式|129_用户EMAIL|188_上海股东|189_深圳股东|138_通讯密码|1117_银行代码|1118_银行 营业部|1119_银行股东代码登录市场|1234_柜台类别|1214_断线重联标志|1230_查询模式|1216_VIP标志|1235_机器信息|1243_受限模式|1248_SESSION信息|1257_重定向标志|1258_重定向信息|1292_手机机器信息|1297_登录输入参数|1244_机器特征码|1300_客户端内部版本|1301_版本字符串|
===============
120_产品账号|122_客户名称|110_委托方式|411_开放式基金标识|1212_营业部ID|149_返回信息|1216_VIP标志|125_帐号类别|1224_非交易帐号标志|281_融资融券标识|220_客户权限代码|221_客户权限名称|1247_所需认证方式|1244_机器特征码|295_信用交易提示信息|1264_令牌|1227_是否匹配风险等级|1291_登录返回参数|450_开户类别|251_签署日期|276_OTC交易标志|252_可否转融通|253_签署途径|1233_句柄|1213_保留信息|
*/
#define REQUEST_100		100 // 不同的平台返回的不一样，其中
/*
...
/*
120_产品账号|134_交易密码|121_产品账号|125_帐号类别|123_股东代码|110_委托方式|5250_交易资金帐号|5251_多资金帐号|5252_CPUID|5253_HDID|5254_信用股东列表|5255_子系统标识|5256_客户类型|5257_信用标识|5258_客户姓名|5259_GUID|5260_手机缓存|
===============
120_产品账号|125_帐号类别|1224_非交易帐号标志|281_融资融券标识|1213_保留信息|
*/
#define REQUEST_148		148

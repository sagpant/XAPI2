...
public:
	...
	virtual int SendRequests(IN RequestRespone_STRUCT** ppRequests, int count) = 0;

	virtual RequestRespone_STRUCT* MakeQueryData(IN int requestType, ReqQueryData_STRUCT* query) = 0;

	virtual RequestRespone_STRUCT* MakeOrder(IN int requestType, Order_STRUCT* pOrder) = 0;
	// 撤单
